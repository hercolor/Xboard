...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'support_contact_label' => 'nullable|string',
        'support_contact_url' => 'nullable|url',
        'support_group_label' => 'nullable|string',
        'support_group_url' => 'nullable|url',
        // subscribe
        'plan_change_enable' => '',
    ...
    public function messages()
    {
        ...
        return [
            ...
            'support_contact_url.url' => '支持联系方式URL格式不正确，必须携带http(s)://',
            'support_group_url.url' => '支持群组URL格式不正确，必须携带http(s)://',
